...
public class MemberEmailRestController implements IResponseController {
    ...
    public ResponseEntity<?> sendEmail(@RequestBody MemberEmailDto requestDto) {
    ...
    public ResponseEntity<?> verifyEmail(@RequestBody MemberEmailDto requestDto) {
        boolean isVerified = memberService.verifyCode(requestDto.getEmail(), requestDto.getCode());
        MemberEmailDto responseDto = new MemberEmailDto();
